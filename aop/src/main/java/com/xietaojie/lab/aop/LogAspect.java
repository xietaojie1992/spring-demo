...
public class LogAspect {
     ...
     * com.xietaojie.lab.cron ：AOP 所切的服务的包名，即需要进行横切的业务类
     * 包名后面的 ..                   ：表示当前包及子包
     * 第二个 *                       ：表示类名，* 表示所有类
     ...
     *
     */
    //@Pointcut("execution (public * com.xietaojie.lab.rest..*.*(..))") // 匹配 com.xietaojie.lab.rest 包下所有方法
     ...
     */
    //@Pointcut("execution (* com.xietaojie.lab.cron..*.*(..))")
    // @Pointcut("within(com.xietaojie.lab.cron.*)")
    // public void cronLog() {
    // }
